      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Each row from seed to harvest, by bed and by stage.
          </p>
        </div>
    ...
    <Card className="group flex flex-col">
      <CardContent className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
          <Field label="Bed" value={planting.bed ?? "—"} />
...
function AddPlantingDialog({
  ...
  const submit = () => {
    ...
    onClose();
    toast.success("Planting added to the field log.");
  };
  ...
  return (
    <DialogContent className="sm:max-w-md">
      <DialogHeader>
        ...
        <DialogDescription>
          A single bed or row. Add as many as you like.
        </DialogDescription>
      </DialogHeader>
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <Label htmlFor="bed">Bed / location</Label>
            <Input
              id="bed"
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            id="pnotes"
            placeholder="Optional — soil, companion plant, observations"
            rows={2}
            value={notes}
      ...
      <DialogFooter>
        ...
        <Button onClick={submit}>Add to field log</Button>
      </DialogFooter>
    </DialogContent>
  );
}
